...
title('Final Temperature Distribution (t = 600 s)');
legend('Matrix Inverse', 'Richardson Iteration')
grid on;
...
grid on;
allObjs = findall(gcf, '-property', 'FontName');
set(allObjs, 'FontName', 'Times New Roman', 'FontSize', 12);
saveas(gcf, "Direct_and_RichIterSol","png")
